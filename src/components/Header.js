    ...
    return (
        <div class="header">
            <div class="logo-container">
                <img class="logo" src={LOGO_URL}></img>
            </div>
            <div class="nav-items">
                <ul>
